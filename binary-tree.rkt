...
(define (inorder tree)
  (cond ((empty-tree? tree) '())
        ((and (empty-tree? (left tree)) (not (empty-tree? (right tree))))
         (cons (datum tree) (inorder (right tree))))
        ((and (empty-tree? (right tree)) (not (empty-tree? (left tree))))
         (append (inorder (left tree)) (list (datum tree))))
        (else
         (append (inorder (left tree)) (list (datum tree)) (inorder (right tree))))))
